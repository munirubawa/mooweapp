...
class FlippableWidget extends StatefulWidget {
  ...
  const FlippableWidget({Key? key, @required this.frontWidget, @required this.backWidget, this.isFront = true}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: Transform(
          ...
          child: isFront!
              ? widget.frontWidget
              : Transform(transform: Matrix4.identity()..rotateX(pi), alignment: Alignment.center, child: widget.backWidget),
        ));
  }
}
