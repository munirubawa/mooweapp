...
//     const BusinessGroupMembersScreen({Key? key, required this.chatRoom}): super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     enumServices.chatTypes = chatRoom?.chatType;
//     return Scaffold(
//       body: Container(
//         width: Get.width,
...
//                   children: groupChatController.groupMembers.map((element) => GestureDetector(
//                     onTap: (){
...
//                                 TransactionActionType.TRANSFER_FUNDS_FROM_GROUP_CHAT_TO_A_PEER;
...
//                         ),
//                       )
//                           : Icon(Icons.person, size: Get.width * 0.1,),
//                       title:
//                       Row(
//                         children: [
...
//                           Text(
//                             "${element.get(memberModel.firstName).toString().capitalize!} ${element
...
//                       ),
//                       isThreeLine: true,
//                       subtitle: MemberSubTitle(member:element, chatRoom: chatRoom,),
...
//         ),
//       ),
//       floatingActionButton: chatRoom!.supperAdmin!.contains(chatServices.localMember!.get(memberModel.userUID)) || chatRoom!.admins!.contains(chatServices.localMember!.get(memberModel.userUID))
...
//             Get.to(()=> DisplayContacts(backgroundColor: Colors.white,));
//           }
//         },
