...
class GroupMembersScreen extends StatelessWidget {
  ...
  const GroupMembersScreen({Key? key, required this.chatRoom}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    enumServices.chatTypes = chatRoom?.chatType;
    if(groupChatController.memberDisplayType ==GroupMemberDisplayType.DISPLAY_TYPE_NOT_SET) {
          ...
          children: [
            Column(
              children: [
                Expanded(
                    child: Obx(() => ListView(
                          children: groupChatController.groupMembers
                              .map((element){
